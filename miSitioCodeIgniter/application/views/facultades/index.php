...
<?= form_open('index.php/facultades/search', array('class' => 'form-search')); ?>
	<div class="row" style="margin:1em 0;">
		...
		<div class="col-md-4">
			<div class="input-group">
	       		<?= anchor('facultades/create', ' Agregar', array('class' => 'btn btn-primary glyphicon glyphicon-plus'));?>
	    	</div>
		</div>
	</div>
<?= form_close(); ?>
				...
				<div class="form-group">
					<div class="col-md-offset-1">
						<div class="col-md-10">
							...
							<?= anchor('facultades/delete/'.$registro->id, ' Eliminar',array('class'=>'btn btn-danger glyphicon glyphicon-trash', 'onClick'=>"return confirm('¿Estas Seguro?');")); ?>
						</div>				
					</div>
				</div>
