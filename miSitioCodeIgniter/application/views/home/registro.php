<?= form_open('index.php/home/registrarse', array('class'=>'form-horizontal jumbotron')); ?>
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-md-4">
				<input class="form-control" type="text" name="id_perfil" value="<?= $perfil->nombre; ?>" disabled/>
			</div>
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-md-4">
				<input class="form-control" type="text" name="id_categoria" value="<?= $categoria->nombre; ?>" disabled/>
			</div>
