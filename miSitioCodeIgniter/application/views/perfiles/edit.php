<?= form_open('index.php/perfiles/update', array('class'=>'form-horizontal jumbotron')); ?>
	...
	<div class="form-group">
		<div class="col-sm-offset-2">
			...
			<?= anchor('perfiles/index', 'Cancelar',array('class'=>'btn btn-warning')); ?>
			<?= anchor('perfiles/delete/'.$registro->id, 'Eliminar',array('class'=>'btn btn-danger', 'onClick'=>"return confirm('¿Estas Seguro?');")); ?>
		</div>
	</div>
<?= form_close(); ?>
