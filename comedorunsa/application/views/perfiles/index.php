...
<table class="table table-bordered table-striped table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><a class="glyphicon glyphicon-pencil" data-toggle="modal" data-target="<?= "#myModalEditar".$registro->id ?>"></a></td>
			<td><?= anchor('perfiles/perfiles_tipos_operaciones/'.$registro->id, ' ',array('class'=>'glyphicon glyphicon-lock')); ?></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
</table>
