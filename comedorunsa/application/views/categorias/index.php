<div class="page-header">	
	<h1>Categorías <small>mantenimiento de registros</small></h1>
</div>
...
<?= form_open('index.php/categorias/search', array('class' => 'form-search')); ?>
	<div class="row" style="margin:1em 0;">
		...
		<div class="col-md-4">
			<div class="input-group">
	       		<?= anchor('categorias/create', ' Agregar', array('class' => 'btn btn-primary glyphicon glyphicon-plus'));?>
	    	</div>
		</div>
	</div>
<?= form_close(); ?>
	...
	<div class="modal-dialog">
    	<div class="modal-content">
      	...
      	<div class="modal-body">
      		<?= form_open('index.php/categorias/update', array('class'=>'form-horizontal')); ?>
				<legend>Editando una Categoría</legend>
				...
				<div class="form-group">
					<div class="col-md-offset-1">
						<div class="col-md-10">
							...
							<?= anchor('categorias/delete/'.$registro->id, ' Eliminar',array('class'=>'btn btn-danger glyphicon glyphicon-trash', 'onClick'=>"return confirm('¿Estas Seguro?');")); ?>
						</div>				
					</div>
				</div>
